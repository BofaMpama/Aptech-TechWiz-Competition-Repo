...
import 'package:pawfect/modules/shelter_admin/shelter_admin_viewmodel.dart';
...
class ShelterAdminProfileScreen extends StatefulWidget {
  const ShelterAdminProfileScreen({super.key});
  static const String route = '/shelter-admin-profile';

  @override
  State<ShelterAdminProfileScreen> createState() => _ShelterAdminProfileScreenState();
}

class _ShelterAdminProfileScreenState extends State<ShelterAdminProfileScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ChangeNotifierProvider(
          create: (_) => ShelterAdminProfileViewModel(),
          child: Consumer<ShelterAdminProfileViewModel>(
                      ...
                      PageInput(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) {
                            return 'Shelter/Organization name is required';
                          }
                          return null;
                        },
                      ),
